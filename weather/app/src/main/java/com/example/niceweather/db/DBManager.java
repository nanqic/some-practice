...
public class DBManager {
    ...
    /* 根据城市名称，替换信息内容*/
    public static int updateInfoByCity(String city,String data){
        ContentValues values = new ContentValues();
        values.put("data",data);
        return database.update("info",values,"city=?",new String[]{city});
    }
    /* 新增一条城市记录*/
    public static long addCityInfo(String city,String data){
        ContentValues values = new ContentValues();
    ...
    public static List<DatabaseBean>queryAllInfo(){
        ...
        while (cursor.moveToNext()) {
            ...
            String city = cursor.getString(cursor.getColumnIndex("city"));
            String data = cursor.getString(cursor.getColumnIndex("data"));
            DatabaseBean bean = new DatabaseBean(id, city, data);
            list.add(bean);
        }
        return list;
    }
