package com.example.niceweather.city_manager;
...
import com.example.niceweather.MainActivity;
import com.example.niceweather.R;
import com.example.niceweather.base.BaseActivity;
...
public class SearchCityActivity extends BaseActivity implements View.OnClickListener{
    ...
    ImageView submitIv;
    GridView searchGv;
    String[]hotCitys = {"北京","上海","广州","深圳","珠海","郑州","南京","苏州","厦门","长沙","成都","福州",
